...
import (
	...
	helper "github.com/jjggzz/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/jjggzz/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/jjggzz/truss/gengokit/general-service"
		)
